(function(){console.log("Member signup 2026 script loaded");const c={emerging:{name:"Emerging",planId:"pln_emerging-i59k0l22",monthlyPriceId:"prc_2026-emerging-monthly-fd2ia06uj",yearlyPriceId:"prc_2026-emerging-annual-lk2i906t0"},professional:{name:"Professional",planId:"pln_professional-ic970osr",monthlyPriceId:"prc_2026-professional-monthly-e72ib06fg",yearlyPriceId:"prc_2026-professional-annual-8x2ix01w6"},"not-for-profit":{name:"Not For Profit",planId:"pln_not-for-profit-qaa106a4",monthlyPriceId:"prc_2026-not-for-profit-monthly-442j001xz",yearlyPriceId:"prc_2026-not-for-profit-annual-0j2go0ypj"},"small-business":{name:"Small Business",planId:"pln_small-business-qsa506lc",monthlyPriceId:"prc_2026-small-business-monthly-wv2gm0yo4",yearlyPriceId:"prc_2026-small-business-annual-el2ic068k"},"large-business":{name:"Large Business",planId:"pln_medium-large-business-9qa706pj",monthlyPriceId:"prc_2026-medium-large-business-monthly-3m2gn0yxa",yearlyPriceId:"prc_2026-medium-large-business-annual-su2iy0155"},"spaces-suppliers":{name:"Spaces / Suppliers",planId:"pln_creative-spaces-suppliers-ck5s08g3",monthlyPriceId:"prc_spaces-suppliers-monthly-odbt0bpb",yearlyPriceId:"prc_spaces-suppliers-yearly-o0bo07rj"}},I=[{id:"64bfb65db1569eeda7582433",name:"Bell",slug:"bell"},{id:"64bfb65d757e05b74ba0e403",name:"Blackheath",slug:"blackheath"},{id:"64bfb65d6a8497d80eb5b5c6",name:"Blaxland",slug:"blaxland"},{id:"64bfb65d409f7c767042076c",name:"Bullaburra",slug:"bullaburra"},{id:"64bfb65d409f7c767042076d",name:"Faulconbridge",slug:"faulconbridge"},{id:"64bfb65d655ee21e8c72ee13",name:"Glenbrook",slug:"glenbrook"},{id:"6aaba004cf957261a1fbdd66",name:"Hawkesbury Heights",slug:"hawkesbury-heights"},{id:"64bfb65d2cc46c71a5be8efb",name:"Hazelbrook",slug:"hazelbrook"},{id:"64bfb65d7519806dd636ca2a",name:"Katoomba",slug:"katoomba"},{id:"64bfb65e2cc46c71a5be8f19",name:"Lapstone",slug:"lapstone"},{id:"64bfb65e57a4cc3165c39201",name:"Lawson",slug:"lawson"},{id:"64bfb65ec791453caa2f9d46",name:"Leura",slug:"leura"},{id:"64bfb65ec791453caa2f9d4f",name:"Linden",slug:"linden"},{id:"64bfb65e75299ea8759da3c3",name:"Medlow Bath",slug:"medlow-bath"},{id:"64bfb65ec016ed44dbb8add3",name:"Megalong Valley",slug:"megalong-valley"},{id:"64bfb65ec7c3a0d4663a1577",name:"Mount Irvine",slug:"mount-irvine"},{id:"6aaba005c9468760f802a52e",name:"Mount Riverview",slug:"mount-riverview"},{id:"64bfb65fafe29b2df8a63f02",name:"Mount Tomah",slug:"mount-tomah"},{id:"64bfb65f7519806dd636cccf",name:"Mount Victoria",slug:"mount-victoria"},{id:"64bfb65f2cc46c71a5be9045",name:"Mount Wilson",slug:"mount-wilson"},{id:"64bfb65f2cc46c71a5be907d",name:"Springwood",slug:"springwood"},{id:"64bfb65feec6228116d7a9f3",name:"Sun Valley",slug:"sun-valley"},{id:"64bfb65f73964b051a9b6baf",name:"Valley Heights",slug:"valley-heights"},{id:"64bfb65fd304d7de5fc6ecf0",name:"Warrimoo",slug:"warrimoo"},{id:"64bfb65f9f89e1af537ca7e1",name:"Wentworth Falls",slug:"wentworth-falls"},{id:"64bfb65fc3353671103219b0",name:"Winmalee",slug:"winmalee"},{id:"64bfb65f363259218e7640bf",name:"Woodford",slug:"woodford"},{id:"64bfb66060c8908f983dd9e6",name:"Yellow Rock",slug:"yellow-rock"}],S=`
    .ms-container {
      font-family: inherit;
      width: 100%;
      max-width: 600px;
  ...
  `;function q(){const e=new URLSearchParams(window.location.search);let r=e.get("type"),s=e.get("billing")||"monthly";if(!r||!c[r]){const i=window.location.pathname.match(/\/join\/signup\/2026\/([^\/]+)/);i&&c[i[1]]?r=i[1]:r=null}return s!=="monthly"&&s!=="yearly"&&(s="monthly"),{type:r,billing:s}}function E(e,r){return`${e} ${r}`.toLowerCase().replace(/[^a-z0-9]+/g,"-").replace(/^-|-$/g,"")}function L(){let e='<option value="">Select your suburb...</option>';return I.forEach(r=>{e+=`<option value="${r.id}" data-slug="${r.slug}">${r.name}</option>`}),`<select class="ms-form-input" id="ms-suburb" required>${e}</select>`}function C(){return new Promise((e,r)=>{let s=0;const i=50,a=setInterval(()=>{s++,window.$memberstackDom?(clearInterval(a),e()):s>=i&&(clearInterval(a),r(new Error("Memberstack not loaded")))},100)})}function h(e){return/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(e)}function y(e){return e.length>=8}function M(e,r,s){const i=c[r],a=s==="yearly"?"Yearly":"Monthly";e.innerHTML=`
    ...
    `,z(e,r,s)}function z(e,r,s){e.querySelector(".ms-form");const i=e.querySelector("#ms-submit-btn"),a=e.querySelector("#ms-email"),l=e.querySelector("#ms-password"),_=e.querySelector("#ms-email-error"),B=e.querySelector("#ms-password-error"),n=e.querySelector("#ms-error-banner");a.addEventListener("blur",()=>{const o=h(a.value);a.classList.toggle("error",!o&&a.value),_.classList.toggle("visible",!o&&a.value)}),l.addEventListener("blur",()=>{const o=y(l.value);l.classList.toggle("error",!o&&l.value),B.classList.toggle("visible",!o&&l.value)}),i.addEventListener("click",async()=>{var k;n.style.display="none";const o=e.querySelector("#ms-first-name").value.trim(),u=e.querySelector("#ms-last-name").value.trim(),p=a.value.trim(),f=l.value,b=e.querySelector("#ms-suburb"),w=b.value,$=((k=b.options[b.selectedIndex])==null?void 0:k.text)||"",N=e.querySelector("#ms-confirm-location").checked,j=e.querySelector("#ms-confirm-creative").checked;if(!o||!u){t(n,"Please enter your first and last name");return}if(!p||!h(p)){t(n,"Please enter a valid email address"),a.classList.add("error");return}if(!w){t(n,"Please select your suburb");return}if(!f||!y(f)){t(n,"Password must be at least 8 characters"),l.classList.add("error");return}if(!N){t(n,"Please confirm that you live or work within the Blue Mountains");return}if(!j){t(n,"Please confirm that you work in the creative industries");return}i.disabled=!0,i.textContent="Creating account...";try{const m=["small-business","large-business","not-for-profit","spaces-suppliers"].includes(r)?"":E(o,u),P=c[r],A=s==="yearly"?P.yearlyPriceId:P.monthlyPriceId,g=await window.$memberstackDom.signupMemberEmailPassword({email:p,password:f,customFields:{"first-name":o,"last-name":u,slug:m,suburb:$,"suburb-id":w,"membership-type":r,"billing-frequency":s,"onboarding-complete":"false"}});if(console.log("Signup result:",g),g.data&&g.data.member)i.textContent="Redirecting to checkout...",await window.$memberstackDom.purchasePlansWithCheckout({priceId:A,successUrl:window.location.origin+"/profile/onboarding"});else throw new Error("Signup failed - no member data returned")}catch(d){console.error("Signup error:",d),i.disabled=!1,i.textContent="Create Account & Continue to Payment";let m="An error occurred. Please try again.";d.message&&(d.message.includes("already exists")||d.message.includes("already registered")?m="An account with this email already exists. Please log in instead.":d.message.includes("password")?m="Password does not meet requirements. Please use at least 8 characters.":m=d.message),t(n,m)}})}function t(e,r){e.textContent=r,e.style.display="block",e.scrollIntoView({behavior:"smooth",block:"center"})}function x(e,r){e.innerHTML=`
      <div class="ms-container">
        <div class="ms-form">
