(function(){console.log("Member onboarding Supabase script loaded");const M="https://epszwomtxkpjegbjbixr.supabase.co",O="sb_publishable_567NLTP3qU8_ONMFs44eow_WoNrIlCH",T="member-images",ae=["small-business","large-business","not-for-profit","partner","spaces-suppliers"],ne="spaces-suppliers";let g=null,b=1,N=5,u=null,A=null,k={directories:[],subDirectories:[],spaceCategories:[],supplierCategories:[]},E=[],s={profileImageUrl:null,profileImageFile:null,featureImageUrl:null,featureImageFile:null,bio:"",businessName:"",suburb:null,spaceOrSupplier:null,chosenDirectories:[],spaceCategories:[],supplierCategories:[],businessAddress:"",displayAddress:!1,openingHours:{monday:"",tuesday:"",wednesday:"",thursday:"",friday:"",saturday:"",sunday:""},displayOpeningHours:!1,website:"",instagram:"",facebook:"",linkedin:"",tiktok:"",youtube:""};const D=["Monday","Tuesday","Wednesday","Thursday","Friday","Saturday","Sunday"],le=`
  ...
  `;function de(){return new Promise((e,t)=>{let o=0;const r=50,a=setInterval(()=>{o++,window.$memberstackDom&&window.supabase?(clearInterval(a),e()):o>=r&&(clearInterval(a),t(new Error("Dependencies not loaded (Memberstack or Supabase)")))},100)})}function B(e){return ae.includes(e)}function ce(e){return e===ne}function pe(e){return e.toLowerCase().replace(/[^a-z0-9]+/g,"-").replace(/^-|-$/g,"").replace(/-+/g,"-")}async function ue(e,t=null){if(!e||e.length<3)return{available:!1,error:"Slug must be at least 3 characters"};try{let o=g.from("members").select("id, slug").eq("slug",e);t&&(o=o.neq("id",t));const{data:r,error:a}=await o;return a?(console.error("Error checking slug:",a),{available:!0}):{available:!r||r.length===0,error:r&&r.length>0?"This name is already taken":null}}catch(o){return console.error("Error checking slug:",o),{available:!0}}}const R={instagram:{baseUrl:"https://www.instagram.com/",patterns:[/instagram\.com\/([^\/\?]+)/i,/^@?([a-zA-Z0-9._]+)$/]},facebook:{baseUrl:"https://www.facebook.com/",patterns:[/facebook\.com\/([^\/\?]+)/i,/^([a-zA-Z0-9.]+)$/]},linkedin:{baseUrl:"https://www.linkedin.com/in/",patterns:[/linkedin\.com\/(in|company)\/([^\/\?]+)/i,/^([a-zA-Z0-9-]+)$/]},tiktok:{baseUrl:"https://www.tiktok.com/@",patterns:[/tiktok\.com\/@?([^\/\?]+)/i,/^@?([a-zA-Z0-9._]+)$/]},youtube:{baseUrl:"https://www.youtube.com/",patterns:[/youtube\.com\/(channel|c|user|@)\/([^\/\?]+)/i,/youtube\.com\/([^\/\?]+)/i,/^@?([a-zA-Z0-9_-]+)$/]}};function j(e,t=null){if(!e||!e.trim())return{valid:!0,url:""};if(e=e.trim(),e.includes(" "))return{valid:!1,error:"Please enter only one URL (no spaces)"};if((e.match(/https?:\/\//gi)||[]).length>1)return{valid:!1,error:"Please enter only one URL"};if(/^https?:\/\//i.test(e))try{return new URL(e),{valid:!0,url:e}}catch{return{valid:!1,error:"Invalid URL format"}}if(t==="website")return/^[a-zA-Z0-9][a-zA-Z0-9-]*\.[a-zA-Z]{2,}/.test(e)?{valid:!0,url:"https://"+e}:{valid:!1,error:"Please enter a full website URL (e.g., https://example.com)"};if(t&&R[t]){const r=R[t];if(e.toLowerCase().includes(t.toLowerCase()+".com"))return{valid:!0,url:"https://"+e.replace(/^(https?:\/\/)?/i,"")};for(const a of r.patterns){const n=e.match(a);if(n){const i=n[n.length-1];return i.toLowerCase()===t.toLowerCase()?{valid:!1,error:`Please enter your ${t} profile URL or username`}:{valid:!0,url:r.baseUrl+i.replace(/^@/,"")}}}return{valid:!1,error:`Please enter a valid ${t} URL or username`}}return{valid:!1,error:"Invalid URL"}}function me(){const e=[];return["website","instagram","facebook","linkedin","tiktok","youtube"].forEach(o=>{const r=s[o];if(r&&r.trim()){const a=j(r,o);a.valid?s[o]=a.url:e.push({platform:o,error:a.error})}}),e}async function ge(){try{const{data:e,error:t}=await g.from("directories").select("id, name, slug").order("display_order");if(t)throw t;const{data:o,error:r}=await g.from("sub_directories").select("id, name, slug, directory_id").order("name");if(r)throw r;const{data:a,error:n}=await g.from("creative_space_categories").select("id, name, slug").order("name");if(n)throw n;const{data:i,error:l}=await g.from("supplier_categories").select("id, name, slug").order("name");if(l)throw l;return k={directories:e||[],subDirectories:o||[],spaceCategories:a||[],supplierCategories:i||[]},k}catch(e){throw console.error("Error loading categories:",e),e}}async function fe(){try{const{data:e,error:t}=await g.from("suburbs").select("id, name, webflow_id").order("name");if(t)throw t;return E=e||[],E}catch(e){return console.error("Error loading suburbs:",e),[]}}async function be(e){var i,l,d,c;const{data:t}=await g.from("members").select("*").eq("memberstack_id",e).maybeSingle();if(t)return t;const o=(i=u.customFields)==null?void 0:i["membership-type"],r=await Y(o),{data:a,error:n}=await g.from("members").insert({memberstack_id:e,email:((l=u.auth)==null?void 0:l.email)||null,first_name:((d=u.customFields)==null?void 0:d["first-name"])||null,last_name:((c=u.customFields)==null?void 0:c["last-name"])||null,subscription_status:"active",membership_type_id:r,profile_complete:!1,is_deleted:!1}).select().single();return n?(console.error("getOrCreateMember failed:",n),null):(console.warn("Member record created in onboarding (webhook had not fired):",e),a)}async function Y(e){if(!e)return null;try{const{data:t,error:o}=await g.from("membership_types").select("id").eq("slug",e).single();return o||!t?(console.warn("Membership type not found for slug:",e),null):t.id}catch(t){return console.error("Error looking up membership type:",t),null}}async function ye(e,t){if(!e)return null;let o=e,r=1;for(;;){const{data:a,error:n}=await g.from("members").select("memberstack_id").eq("slug",o).maybeSingle();if(n)return console.error("Error checking slug:",n),o;if(!a||a.memberstack_id===t)return o;r++,o=`${e}-${r}`,console.log(`Slug conflict, trying: ${o}`)}}const W=3*1024*1024,F=2e3;async function he(e){return e.size<=W?(console.log(`Image ${e.name} is ${(e.size/1024/1024).toFixed(2)}MB - no compression needed`),e):(console.log(`Compressing image ${e.name} from ${(e.size/1024/1024).toFixed(2)}MB...`),new Promise((t,o)=>{const r=new Image,a=document.createElement("canvas"),n=a.getContext("2d");r.onload=()=>{let{width:i,height:l}=r;if(i>F||l>F){const c=Math.min(F/i,F/l);i=Math.round(i*c),l=Math.round(l*c)}a.width=i,a.height=l,n.drawImage(r,0,0,i,l);const d=c=>{a.toBlob(p=>{if(!p){o(new Error("Failed to compress image"));return}if(console.log(`Compressed to ${(p.size/1024/1024).toFixed(2)}MB at quality ${c}`),p.size<=W||c<=.3){const m=new File([p],e.name,{type:"image/jpeg",lastModified:Date.now()});t(m)}else d(c-.1)},"image/jpeg",c)};d(.8)},r.onerror=()=>o(new Error("Failed to load image for compression")),r.src=URL.createObjectURL(e)}))}async function $(e,t,o){try{const r=await he(e),{data:a}=await g.storage.from(T).list(t);if(a&&a.length>0){const c=a.filter(p=>p.name.startsWith(`${o}_`)).map(p=>`${t}/${p.name}`);if(c.length>0){const{error:p}=await g.storage.from(T).remove(c);p?console.warn("Error deleting old images:",p):console.log(`Deleted ${c.length} old ${o} image(s)`)}}const n=`${o}_${Date.now()}.jpg`,i=`${t}/${n}`,{error:l}=await g.storage.from(T).upload(i,r,{cacheControl:"3600",upsert:!0});if(l)throw l;const{data:{publicUrl:d}}=g.storage.from(T).getPublicUrl(i);return d}catch(r){throw console.error(`Error uploading ${o} image:`,r),r}}async function C(e){var t;if(!(!(u!=null&&u.id)||!g))try{const o=u.id,r={onboarding_step:e,onboarding_started_at:new Date().toISOString()};if(s.profileImageFile){const n=await $(s.profileImageFile,o,"profile");r.profile_image_url=n,s.profileImageUrl=n,s.profileImageFile=null}else s.profileImageUrl&&(r.profile_image_url=s.profileImageUrl);if(s.featureImageFile){const n=await $(s.featureImageFile,o,"feature");r.header_image_url=n,s.featureImageUrl=n,s.featureImageFile=null}else s.featureImageUrl&&(r.header_image_url=s.featureImageUrl);s.bio&&(r.bio=s.bio),s.businessName&&(r.business_name=s.businessName),(t=s.suburb)!=null&&t.id&&(r.suburb_id=s.suburb.id),s.businessAddress&&(r.business_address=s.businessAddress),r.show_address=s.displayAddress,r.show_opening_hours=s.displayOpeningHours,s.openingHours.monday&&(r.opening_monday=s.openingHours.monday),s.openingHours.tuesday&&(r.opening_tuesday=s.openingHours.tuesday),s.openingHours.wednesday&&(r.opening_wednesday=s.openingHours.wednesday),s.openingHours.thursday&&(r.opening_thursday=s.openingHours.thursday),s.openingHours.friday&&(r.opening_friday=s.openingHours.friday),s.openingHours.saturday&&(r.opening_saturday=s.openingHours.saturday),s.openingHours.sunday&&(r.opening_sunday=s.openingHours.sunday),s.website&&(r.website=s.website),s.instagram&&(r.instagram=s.instagram),s.facebook&&(r.facebook=s.facebook),s.linkedin&&(r.linkedin=s.linkedin),s.tiktok&&(r.tiktok=s.tiktok),s.youtube&&(r.youtube=s.youtube);const{error:a}=await g.from("members").update(r).eq("memberstack_id",o);a?console.warn("Error saving progress:",a):console.log(`Progress saved at step ${e}`)}catch(o){console.warn("Error saving progress:",o)}}async function ve(){if(!(u!=null&&u.id)||!g)return null;try{const{data:e,error:t}=await g.from("members").select("*").eq("memberstack_id",u.id).single();if(t||!e)return null;if(e.onboarding_step&&e.onboarding_step>0){if(console.log("Restoring progress from step",e.onboarding_step),e.profile_image_url&&(s.profileImageUrl=e.profile_image_url),e.header_image_url&&(s.featureImageUrl=e.header_image_url),e.bio&&(s.bio=e.bio),e.business_name&&(s.businessName=e.business_name),e.suburb_id){const i=E.find(l=>l.id===e.suburb_id);i&&(s.suburb={id:i.id,name:i.name})}e.business_address&&(s.businessAddress=e.business_address),s.displayAddress=e.show_address||!1,s.displayOpeningHours=e.show_opening_hours||!1,s.openingHours={monday:e.opening_monday||"",tuesday:e.opening_tuesday||"",wednesday:e.opening_wednesday||"",thursday:e.opening_thursday||"",friday:e.opening_friday||"",saturday:e.opening_saturday||"",sunday:e.opening_sunday||""},e.website&&(s.website=e.website),e.instagram&&(s.instagram=e.instagram),e.facebook&&(s.facebook=e.facebook),e.linkedin&&(s.linkedin=e.linkedin),e.tiktok&&(s.tiktok=e.tiktok),e.youtube&&(s.youtube=e.youtube),e.is_creative_space?s.spaceOrSupplier="space":e.is_supplier&&(s.spaceOrSupplier="supplier");const o=e.id,{data:r}=await g.from("member_sub_directories").select("sub_directory_id").eq("member_id",o);r&&(s.chosenDirectories=r.map(i=>i.sub_directory_id));const{data:a}=await g.from("member_space_categories").select("space_category_id").eq("member_id",o);a&&(s.spaceCategories=a.map(i=>i.space_category_id));const{data:n}=await g.from("member_supplier_categories").select("supplier_category_id").eq("member_id",o);return n&&(s.supplierCategories=n.map(i=>i.supplier_category_id)),e.onboarding_step}return null}catch(e){return console.warn("Error loading saved progress:",e),null}}async function xe(){var t,o,r,a,n,i,l,d;const e=u.id;try{let c=s.profileImageUrl,p=s.featureImageUrl;s.profileImageFile&&(c=await $(s.profileImageFile,e,"profile")),s.featureImageFile&&(p=await $(s.featureImageFile,e,"feature"));const m=(t=u==null?void 0:u.customFields)==null?void 0:t["membership-type"],f=await Y(m);console.log("Membership type:",m,"-> ID:",f);const h=["small-business","large-business","not-for-profit","partner","spaces-suppliers"],v=(m==null?void 0:m.toLowerCase().replace(/[^a-z0-9]+/g,"-").replace(/^-|-$/g,""))||"",w=h.includes(v)&&s.businessName,S=`${((o=u.customFields)==null?void 0:o["first-name"])||""} ${((r=u.customFields)==null?void 0:r["last-name"])||""}`.trim(),_=w?s.businessName:S||s.businessName||"member",De=_.toLowerCase().replace(/[^a-z0-9]+/g,"-").replace(/^-|-$/g,""),J=await ye(De,e);console.log("Slug generation:",{membershipType:m,useBusinessName:w,displayName:_,slug:J});const Q=!!c,K=!!p,ee=s.bio&&s.bio.length>=50,se=s.chosenDirectories.length>0||s.spaceCategories.length>0||s.supplierCategories.length>0,te=!!((a=s.suburb)!=null&&a.id),z=Q&&K&&ee&&se&&te,{data:H}=await g.from("members").select("profile_completed_at").eq("memberstack_id",e).maybeSingle(),re=(H==null?void 0:H.profile_completed_at)||(z?new Date().toISOString():null);console.log("Profile completion check:",{hasProfileImage:Q,hasFeatureImage:K,hasBio:ee,hasCategories:se,hasLocation:te,isProfileComplete:z,profileCompletedAt:re});const Be={membership_type_id:f,profile_image_url:c,header_image_url:p,bio:s.bio,slug:J,name:_,business_name:s.businessName||null,suburb_id:((n=s.suburb)==null?void 0:n.id)||null,business_address:s.businessAddress||null,show_address:s.displayAddress,show_opening_hours:s.displayOpeningHours,opening_monday:s.openingHours.monday||null,opening_tuesday:s.openingHours.tuesday||null,opening_wednesday:s.openingHours.wednesday||null,opening_thursday:s.openingHours.thursday||null,opening_friday:s.openingHours.friday||null,opening_saturday:s.openingHours.saturday||null,opening_sunday:s.openingHours.sunday||null,website:s.website||null,instagram:s.instagram||null,facebook:s.facebook||null,linkedin:s.linkedin||null,tiktok:s.tiktok||null,youtube:s.youtube||null,is_creative_space:s.spaceOrSupplier==="space",is_supplier:s.spaceOrSupplier==="supplier",profile_complete:z,profile_completed_at:re},{data:ie,error:oe}=await g.from("members").upsert({memberstack_id:e,email:(i=u.auth)==null?void 0:i.email,first_name:((l=u.customFields)==null?void 0:l["first-name"])||null,last_name:((d=u.customFields)==null?void 0:d["last-name"])||null,...Be},{onConflict:"memberstack_id"}).select().single();if(oe)throw oe;const L=ie.id;if(await g.from("member_sub_directories").delete().eq("member_id",L),await g.from("member_space_categories").delete().eq("member_id",L),await g.from("member_supplier_categories").delete().eq("member_id",L),s.chosenDirectories.length>0){const q=s.chosenDirectories.map(U=>({member_id:L,sub_directory_id:U}));await g.from("member_sub_directories").insert(q)}if(s.spaceCategories.length>0){const q=s.spaceCategories.map(U=>({member_id:L,space_category_id:U}));await g.from("member_space_categories").insert(q)}if(s.supplierCategories.length>0){const q=s.supplierCategories.map(U=>({member_id:L,supplier_category_id:U}));await g.from("member_supplier_categories").insert(q)}return await window.$memberstackDom.updateMember({customFields:{"onboarding-complete":"true"}}),console.log("Onboarding data saved to Supabase successfully"),await we(L),console.log("Onboarding data synced to Webflow successfully"),ie}catch(c){throw console.error("Error saving onboarding data:",c),c}}async function we(e){try{const{data:t,error:o}=await g.from("members").select("*").eq("id",e).single();if(o){console.warn("Failed to fetch member for Webflow sync:",o);return}const r=await fetch(`${M}/functions/v1/sync-to-webflow`,{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${O}`,apikey:O},body:JSON.stringify({type:"UPDATE",table:"members",schema:"public",record:t,old_record:null})});if(r.ok)console.log("Webflow sync completed");else{const a=await r.text();console.warn("Webflow sync returned error:",r.status,a)}}catch(t){console.warn("Failed to sync to Webflow:",t)}}function I(e){var o;(o=u==null?void 0:u.customFields)==null||o["membership-type"],N=5;let t='<div class="ms-progress">';for(let r=1;r<=N;r++){let a="ms-progress-step";r<b&&(a+=" completed"),r===b&&(a+=" active"),t+=`<div class="${a}"></div>`}return t+="</div>",t}function ke(e){e.innerHTML=`
    ...
    `,Se(e)}function Se(e){const t=e.querySelector("#profile-upload"),o=e.querySelector("#feature-upload"),r=e.querySelector("#profile-file-input"),a=e.querySelector("#feature-file-input"),n=e.querySelector("#ms-next-btn"),i=e.querySelector("#ms-error-banner");function l(){s.profileImageUrl?(t.innerHTML=`
    ...
    `,Ce(e,o)}function Ce(e,t){const o=e.querySelector("#ms-bio"),r=e.querySelector("#ms-bio-count"),a=t?e.querySelector("#ms-business-name"):null,n=t?e.querySelector("#ms-slug-preview"):null,i=t?e.querySelector("#ms-slug-status"):null,l=e.querySelector("#ms-back-btn"),d=e.querySelector("#ms-next-btn"),c=e.querySelector("#ms-error-banner");let p=null,m=!0;if(o.addEventListener("input",()=>{s.bio=o.value,r.textContent=o.value.length}),a&&i){const f=(v,w)=>{i.className="ms-slug-status "+v;const S=i.querySelector(".ms-slug-icon"),_=i.querySelector(".ms-slug-message");v==="available"?(S.textContent="✓",_.textContent=w||"This name is available",m=!0):v==="taken"?(S.textContent="✗",_.textContent=w||"This name is already taken",m=!1):v==="checking"?(S.textContent="...",_.textContent="Checking availability..."):v==="invalid"?(S.textContent="!",_.textContent=w||"Name must be at least 4 characters",m=!1):(i.className="ms-slug-status",m=!0)},h=async v=>{const w=pe(v);if(n&&(n.textContent=w?`Your URL: mtnsmade.com.au/members/${w}`:""),v.trim().length<4){v.trim().length>0?f("invalid","Name must be at least 4 characters"):f("");return}f("checking");const S=await ue(w,A==null?void 0:A.id);S.available?f("available"):f("taken",S.error)};a.addEventListener("input",()=>{s.businessName=a.value,p&&clearTimeout(p),p=setTimeout(()=>{h(a.value)},500)}),s.businessName&&h(s.businessName)}l.addEventListener("click",()=>{b=1,x(e)}),d.addEventListener("click",async()=>{if(t&&!s.businessName.trim()){y(c,"Please enter your business name");return}if(t&&!m){y(c,"This business name is already taken. Please choose a different name.");return}if(!s.bio.trim()){y(c,"Please enter a bio");return}if(s.bio.trim().length<50){y(c,"Please enter at least 50 characters for your bio");return}b=3,await C(b),x(e)})}function Le(e){var r;const t=(r=u==null?void 0:u.customFields)==null?void 0:r["membership-type"],o=ce(t);e.innerHTML=`
      <div class="ms-container">
        <div class="ms-header">
          <h2>COMPLETE YOUR PROFILE</h2>
    ...
    `}function Z(){let e='<div class="ms-category-section"><div class="ms-category-header" style="font-weight:600;margin-bottom:12px;">Select Space Categories</div><div class="ms-category-grid">';return k.spaceCategories.forEach(t=>{const o=s.spaceCategories.includes(t.id);e+=`
      ...
      `}),e+='</div><div class="ms-selected-count"><span id="space-count">'+s.spaceCategories.length+"</span> selected</div></div>",e}function G(){let e='<div class="ms-category-section"><div class="ms-category-header" style="font-weight:600;margin-bottom:12px;">Select Supplier Categories</div><div class="ms-category-grid">';return k.supplierCategories.forEach(t=>{const o=s.supplierCategories.includes(t.id);e+=`
        <label class="ms-category-item ${o?"selected":""}" data-id="${t.id}">
          <input type="checkbox" value="${t.id}" ${o?"checked":""}>
          ${t.name}
        </label>
      `}),e+='</div><div class="ms-selected-count"><span id="supplier-count">'+s.supplierCategories.length+"</span> selected</div></div>",e}function $e(e){const t=k.subDirectories.find(o=>o.id===e);return t?t.name:e}function Ie(){let e='<div class="ms-category-selector">';return e+='<div class="ms-parent-categories">',k.directories.forEach(t=>{e+=`<button type="button" class="ms-parent-btn" data-parent="${t.id}">${t.name}</button>`}),e+="</div>",k.directories.forEach(t=>{const o=k.subDirectories.filter(r=>r.directory_id===t.id);e+=`<div class="ms-child-categories" data-parent="${t.id}">`,o.forEach(r=>{const a=s.chosenDirectories.includes(r.id);e+=`<button type="button" class="ms-child-btn ${a?"selected":""}" data-id="${r.id}">${r.name}</button>`}),e+="</div>"}),e+=`
    ...
    `;const n=e.querySelectorAll(".ms-loading-step");let i=0;function l(){if(i>0&&n[i-1]){n[i-1].classList.remove("active"),n[i-1].classList.add("complete");const p=n[i-1].querySelector(".ms-loading-step-icon");p&&(p.textContent="✓")}if(i<n.length){n[i].classList.add("active");const p=a[i].duration;i++,setTimeout(l,p)}else setTimeout(()=>{He(e,r)},500)}setTimeout(l,300)}function He(e,t){e.innerHTML=`
      <div class="ms-container">
    ...
    `}function x(e){switch(b){case 1:ke(e);break;case 2:_e(e);break;case 3:Le(e);break;case 4:Fe(e);break;case 5:Oe(e);break}}function y(e,t){e.textContent=t,e.style.display="block",e.scrollIntoView({behavior:"smooth",block:"center"})}function Me(e){e.innerHTML=`
      <div class="ms-container">
        <div class="ms-form">
    ...
    `}function X(e,t){e.innerHTML=`
      <div class="ms-container">
        <div class="ms-form">
          <div class="ms-error-banner" style="display: block;">${t}</div>
        </div>
      </div>
    `}async function V(){var o,r,a;const e=document.querySelector(".onboarding-form")||document.querySelector(".supabase-onboarding-container");if(!e){console.warn("Could not find onboarding container (.onboarding-form or .supabase-onboarding-container)");return}const t=document.createElement("style");t.textContent=le,document.head.appendChild(t),e.innerHTML='<div class="ms-loading">Loading...</div>';try{await de(),g=window.supabase.createClient(M,O);const{data:n}=await window.$memberstackDom.getCurrentMember();if(!n){Me(e);return}if(u=n,!await be(u.id)){X(e,"Unable to load your profile. Please refresh or contact support.");return}if(((o=n.customFields)==null?void 0:o["onboarding-complete"])==="true"){Ne(e);return}await ge(),await fe();const l=(r=n.customFields)==null?void 0:r["suburb-id"],d=(a=n.customFields)==null?void 0:a.suburb;if(l&&d){const p=E.find(m=>m.webflow_id===l);if(p)s.suburb={id:p.id,name:p.name},console.log("Pre-populated suburb from signup (matched to Supabase):",s.suburb);else{const m=E.find(f=>f.name===d);m?(s.suburb={id:m.id,name:m.name},console.log("Pre-populated suburb from signup (matched by name):",s.suburb)):console.warn("Could not find suburb in Supabase:",l,d)}}const c=await ve();c&&c>1&&(b=c,console.log("Resuming onboarding from step",b)),x(e)}catch(n){console.error("Init error:",n),X(e,"Error loading onboarding. Please refresh the page.")}}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",V):V()})();
