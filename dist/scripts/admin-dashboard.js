...
MTNS MADE Team`}async function M(){const[e,t,i,o,n,r,a,s,l,d,c,p]=await Promise.all([F(),H(),V(),J(),Y(),G(),K(),Q(),X(),W(),Z(),B()]);return T=p,{recentMembers:e,memberStats:t,incompleteProfiles:i,failedSignups:o,recentEvents:n,eventStats:r,recentOpportunities:a,opportunityStats:s,recentProjects:l,messageStats:d,recentActivity:c,membershipTypes:p,loadedAt:new Date}}async function F(){const{data:e,error:t}=await m.from("members").select(`
      ...
      `).not("subscription_status","in",'("active","lapsed","deleted")').neq("is_deleted",!0).order("created_at",{ascending:!1}).limit(30);return t?(console.error("Error loading failed signups:",t),[]):e||[]}async function Y(){const{data:e,error:t}=await m.from("events").select("id, name, slug, memberstack_id, member_contact_email, is_draft, is_archived, webflow_id, created_at").order("is_draft",{ascending:!1}).order("created_at",{ascending:!1}).limit(50);return t?(console.error("Error loading recent events:",t),[]):e||[]}async function G(){const{data:e}=await m.from("events").select("id, is_draft, is_archived, webflow_id"),t=(e==null?void 0:e.length)||0,i=(e==null?void 0:e.filter(n=>n.is_draft&&!n.is_archived).length)||0,o=(e==null?void 0:e.filter(n=>!n.is_draft&&!n.is_archived).length)||0;return{total:t,pending:i,published:o}}async function K(){const{data:e,error:t}=await m.from("opportunities").select("id, name, slug, memberstack_id, member_contact_email, opportunity_type, is_draft, is_archived, webflow_id, created_at").order("is_draft",{ascending:!1}).order("created_at",{ascending:!1}).limit(50);if(t)return console.error("Error loading recent opportunities:",t),[];const i=e||[],o=[...new Set(i.map(n=>n.memberstack_id).filter(Boolean))];if(o.length>0){const{data:n}=await m.from("members").select("memberstack_id, first_name, last_name, name").in("memberstack_id",o);if(n){const r=Object.fromEntries(n.map(a=>[a.memberstack_id,a]));i.forEach(a=>{const s=r[a.memberstack_id];s&&(a.member_name=[s.first_name,s.last_name].filter(Boolean).join(" ")||s.name||null)})}}return i}async function Q(){const{data:e}=await m.from("opportunities").select("id, is_draft, is_archived"),t=(e==null?void 0:e.length)||0,i=(e==null?void 0:e.filter(n=>n.is_draft&&!n.is_archived).length)||0,o=(e==null?void 0:e.filter(n=>!n.is_draft&&!n.is_archived).length)||0;return{total:t,pending:i,published:o}}async function X(){const{data:e,error:t}=await m.from("projects").select(`
