        ...
        <div role="listitem" class="w-dyn-item">
          <div class="x-member-card">
            <div class="x-member-feature-image-container">
              ...
              <a href="/members/${o.slug}" class="x-member-feature-image" style="position:absolute;top:0;left:0;right:0;bottom:0;">
                <img src="${d}" loading="lazy" alt="${s}" style="width:100%;height:100%;object-fit:cover;" onerror="this.style.display='none'">
              </a>
            </div>
